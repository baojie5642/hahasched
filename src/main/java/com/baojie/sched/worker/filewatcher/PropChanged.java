package com.baojie.sched.worker.filewatcher;

import com.baojie.sched.service.hotload.BeanPropHolder;
import com.baojie.sched.service.hotload.ResourceHandler;
...
public class PropChanged implements Runnable {
    ...
    private void restartAsyncWork(String spPropKey) {
        ...
        TaskName tn[] = TaskName.values();
        for (TaskName n : tn) {
            BaseTask.release(n.name());
        }
    }
